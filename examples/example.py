...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "The filename of the corpus to pre-process. "
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help=("Assume the corpus input file is in the " "Wikipedia dump format"),
    )
    parser.add_argument(
        "--train",
        "-t",
        ...
        default=0,
        help=(
            "Train the GloVe model with this number of epochs."
            "If not supplied, "
